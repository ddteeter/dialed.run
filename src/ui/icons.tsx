...
export const ICONS = {
  ...
  call: { group: "nav", d: "M6 3H3v18h3M18 3h3v18h-3M12 7v3M9 12.5a3 3 0 106 0 3 3 0 00-6 0M12 15.5v1.5" },
  ...
  trip: { group: "system", d: "M4 20V9l8-5 8 5v11M9 20v-6h6v6M2 20h20" },
  home: { group: "system", d: "M3 11l9-7 9 7M5 9.5V20h14V9.5M10 20v-5h4v5" },
  pack: { group: "system", d: "M5 8h14v13H5zM9 8V5h6v3M5 13h14M12 11v4" },
} as const;
